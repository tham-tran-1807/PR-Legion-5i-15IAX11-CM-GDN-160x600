...
lib.ssMetadata = [
		{name:"PR_Legion_5i_15IAX11_CM_GDN_160x600_atlas_1", frames: [[1134,0,50,50],[0,0,160,600],[162,0,160,600],[324,0,160,600],[486,0,160,600],[648,0,160,600],[810,0,160,600],[972,0,160,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_5i_15IAX11_CM_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion5i15IAX11CMGDN160x600 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: '08443E6120A5964286905EF3E0B3066D',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_5i_15IAX11_CM_GDN_160x600_atlas_1.png", id:"PR_Legion_5i_15IAX11_CM_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['08443E6120A5964286905EF3E0B3066D'] = {
